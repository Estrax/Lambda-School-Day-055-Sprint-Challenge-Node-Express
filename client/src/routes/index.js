        ...
        <Router history={props.history}>
            <div>
                ...
                {/* <Switch>
                    ...
                    <Route path="/users" exact component={ProjectsPage}/>
                    <Route path="/users/new" exact component={NewProjectPage}/>
                    <Route path="/users/:id" exact component={ProjectPage}/>
                    <Route path="/users/:id/edit" exact component={EditProjectPage}/>
                </Switch> */}
            </div>
        </Router>
    );
